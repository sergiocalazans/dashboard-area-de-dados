...
with col_graf1:
    if not df_filtrado.empty:
        ...
        grafico_cargos = px.bar(
            ...
            color='usd',  # Usa o valor como base para o degradê
...
with col_graf4:
    if not df_filtrado.empty:
        ...
        grafico_paises = px.choropleth(media_ds_pais,
            ...
            title='Salário médio de Cientista de Dados por país (Mapa)',
...
with col_graf5:
    if not df_filtrado.empty:
        ...
        grafico_salarios_paises = px.bar(salario_medio_por_pais,
                    x='empresa',
                    y='usd',
                    title='Salário médio de Cientista de Dados por país (Barras)',
                    labels={'empresa': 'País', 'usd': 'Salário médio (USD)'},
                    color='usd', 
                    color_continuous_scale='Blues') 
